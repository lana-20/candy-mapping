...
<title>The Window Is Four Seconds Wide — PNSQC 2026</title>
<style>
...
<header>
  <div class="hgrid">
    <div>
      <p class="kick">Poster &middot; Quality in the Age of Autonomy</p>
      <p class="q">How fast do you have to be to see a bug whose hiding window keeps moving?</p>
      <h1>The window is four<br>seconds wide.</h1>
      <div class="byline">
...
<footer>
  <p><b>Disclosure.</b> Per the PNSQC Generative AI Policy. Tool: Vibium v26.5.31 (CLI + MCP), model
    ...
    Hardened 2026-08-04 with 50 CLI + 50 MCP independent runs of the full journey (real cost $11.71,
    MCP arm). Full write-up and repro scripts at github.com/lana-20/candy-mapping. Thanks to Paul
