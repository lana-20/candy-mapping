...
<div class="figs">
  <div class="fig"><div class="figv a">3.7&ndash;6.1s</div><div class="figl">vulnerability window, moves within a session</div></div>
...
<div class="panel sunk">
  ...
  <div class="find w"><span class="findk">03</span><p><b>The boundary drifts within a single session,
    ...
    the same session, a zero-interaction control click was still swallowed at 6,054ms.</p></div>
